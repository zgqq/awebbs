...
INSERT INTO `awebbs_permission` (`id`, `description`, `name`, `pid`, `url`)
VALUES
	(1, '仪表盘', 'index', 0, NULL),
	(2, '话题', 'topic', 0, NULL),
	(3, '回复', 'reply', 0, NULL),
...
INSERT INTO `awebbs_role` (`id`, `description`, `name`)
VALUES
	(1,'超级管理员','admin'),
	(2,'版主','banzhu'),
	(3,'会员','user');

INSERT INTO `awebbs_role_permission` (`role_id`, `permission_id`)
VALUES
	(1, 7),
	(2, 7),
	(1, 8),
