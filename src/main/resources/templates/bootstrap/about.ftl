  ...
  <div class="col-md-9">
    <div class="panel panel-default">
      ...
      <div class="panel-body topic-detail-content">
        <p> awebbs社区是用Java语言编写的社区（论坛）系统.</p>
        <p>界面布局参照
          <a href="https://cnodejs.org" target="_blank">cnodejs</a>,
          <a href="https://v2ex.com" target="_blank">v2ex</a>
        </p>
        <p>
          欢迎提 <a href="https://github.com/zgqq/awebbs/issues" target="_blank">issues</a>
        </p>
        <p>开源地址:
        <ul>
          <li>
            Github: <a href="http://github.com/zgqq/awebbs"
                       target="_blank">http://github.com/zgqq/awebbs</a>
          </li>
        </ul>
        <p>使用到的技术:
        <ul>
